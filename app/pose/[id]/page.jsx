        ...
        <div className="flex flex-col items-center bg-gray-50 p-6 rounded-lg shadow-inner w-full max-w-md">
          ...
          <div className="flex items-center justify-between w-full mb-4">
            <button
              ...
              className={`px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg transition duration-200 w-1/2 ${
                isRecording
            ...
            <span className="text-gray-700 font-medium">
              Time: {recordingTime}s / 30s
            </span>
          </div>

          <Link
            href={"http://localhost:3000/exercise"}
            className="w-full py-2 font-bold text-black bg-black/20 rounded-lg transition duration-200 text-center"
          >
            Back
          </Link>
        </div>
